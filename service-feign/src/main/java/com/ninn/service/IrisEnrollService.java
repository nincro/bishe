...
@FeignClient(value = "service-iris-enroll",fallback = UploadServiceHystric.class, configuration = IrisEnrollService.MultipartSupportConfig.class)
public interface IrisEnrollService {
